...
export default function ChatActions({
  ...
  return (
    <div className="flex h-10 items-center justify-between border-b border-[rgba(93,74,50,0.14)] px-4">
      ...
      <div className="flex items-center gap-2">
        <motion.button
          ...
          className="flex h-8 items-center gap-1.5 rounded-lg border border-[rgba(93,74,50,0.2)] bg-[rgba(255,252,247,0.78)] px-3 text-xs text-text-secondary transition hover:bg-[rgba(255,252,247,0.96)] hover:text-accent"
        >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={onClear}
          className="flex h-8 items-center gap-1.5 rounded-lg border border-red-500/24 bg-red-500/10 px-3 text-xs text-red-700 transition hover:border-red-500/34 hover:bg-red-500/16 hover:text-red-800"
        >
          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
